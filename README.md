...
[![Build Status](https://travis-ci.org/nacos-group/nacos-sdk-go.svg?branch=master)](https://travis-ci.org/nacos-group/nacos-sdk-go) [![Go Report Card](https://goreportcard.com/badge/gitee.com/LeeScott/nacos-sdk-go)](https://goreportcard.com/report/gitee.com/LeeScott/nacos-sdk-go) ![license](https://img.shields.io/badge/license-Apache--2.0-green.svg)
...
```sh
$ go get -u gitee.com/LeeScott/nacos-sdk-go/v2
```
